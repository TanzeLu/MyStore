 ...
 * @author ltz
 */
public class JacketItem extends javax.swing.JFrame {

    /**
     * Creates new form JacketItem
     */
    public JacketItem() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setPreferredSize(new java.awt.Dimension(586, 430));
    ...
    private void formWindowClosed(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowClosed
        // TODO add your handling code here:
        JacketItem.this.setVisible(false);
       JacketItem.this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JacketItem.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JacketItem().setVisible(true);
            }
        });
    }
