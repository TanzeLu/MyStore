 ...
 * @author ltz
 */
public class TshirtItem extends javax.swing.JFrame {

    /**
     * Creates new form TshirtItem
     */
    public TshirtItem() {
        initComponents();
    }
    ...
    private void cancellBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cancellBtnActionPerformed
        ...
        // TODO add your handling code here:
        TshirtItem.this.setVisible(false);
        TshirtItem.this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TshirtItem.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TshirtItem().setVisible(true);
            }
        });
    }
